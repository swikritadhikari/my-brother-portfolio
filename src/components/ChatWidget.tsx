...
export default function ChatWidget() {
  ...
  const sendMessage = async (e: React.FormEvent) => {
    ...
    const newMsg: ChatMessage = {
      id: `msg-${msgCounter.current}-${new Date().getTime()}`,
      sender: "visitor",
    ...
    portfolioStore.setConversations(
      conversations.map((c) =>
        c.id === activeConv.id || c._id === activeConv._id ? optimisticConv : c,
      ),
    );
    setComposeText("");
            ...
            >
              {!activeConv ? (
                ...
                >
                  ...
                  >
                    Please introduce yourself before we chat.
                  </p>
                      ...
                      <div
                        style={{
                          ...
                          borderBottomRightRadius:
                            msg.sender === "visitor" ? 0 : "1rem",
                          borderBottomLeftRadius:
                            msg.sender === "bot" ? 0 : "1rem",
                          fontSize: "0.85rem",
                          lineHeight: 1.4,
                        }}
                      >
